...
class Bz2CompressTest : public CPPUNIT_NS::TestFixture
{
    CPPUNIT_TEST_SUITE( Bz2CompressTest );
    CPPUNIT_TEST(test_bz2compress);
    CPPUNIT_TEST(test_bz2compress_random);
...
protected:
	...
	CPPUNIT_ASSERT( stx::string::bz2decompress( stx::string::bz2compress(rand1) ) == rand1 );
	CPPUNIT_ASSERT( stx::string::bz2decompress( stx::string::bz2compress(rand2) ) == rand2 );
	CPPUNIT_ASSERT( stx::string::bz2decompress( stx::string::bz2compress(rand3) ) == rand3 );
    }
};

CPPUNIT_TEST_SUITE_REGISTRATION( Bz2CompressTest );
